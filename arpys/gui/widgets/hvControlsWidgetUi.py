...
class HVScanControls_Ui(object):
    def setupUi(self, obj):
        #####################################################################
        # set up user panel layout and give it a title
        #####################################################################
        obj.layout_hv_scan = QVBoxLayout(obj)
        obj.box_k_conv = CollapsibleBox("k conversion")
        obj.layout_hv_scan.addWidget(obj.box_k_conv)
        ...
        obj.layout_hv_scan.addWidget(obj.box_plot_editor)
        ...
        obj.layout_hv_scan.addWidget(obj.text_area)
