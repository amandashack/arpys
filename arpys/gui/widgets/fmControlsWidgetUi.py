...
class FermiMapControls_Ui(object):
    def setupUi(self, obj):
        ...
        obj.cbox_stylesheet.setEnabled(False)
        ...
        obj.layout_x_y_axes.addWidget(obj.lbl_x_label, 0, 0, 2, 1)
        obj.layout_x_y_axes.addWidget(obj.le_xmin, 0, 1, 2, 1)
        obj.layout_x_y_axes.addWidget(obj.le_xmin, 0, 2, 2, 1)
        obj.layout_x_y_axes.addWidget(obj.lbl_y_label, 3, 0, 2, 1)
